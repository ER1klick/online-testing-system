                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <thead>
                        <tr style={{ backgroundColor: '#101820', color: 'white', textAlign: 'left' }}>
                            ...
                            <th style={{ padding: '15px' }}>% правильности</th>
                        ...
                        {results.map((res) => {
                            ...
                            return (
                                <tr key={res.id} style={{ borderBottom: '1px solid #eee' }}>
                                    ...
                                    <td style={{ padding: '15px', fontWeight: 'bold', color: percentage >= 50 ? '#28a745' : '#dc3545' }}>
                                        {percentage}%
                                    </td>
                                    <td style={{ padding: '15px' }}>
                                        {res.isChecked ? (
                                            <span style={{ padding: '4px 10px', borderRadius: '20px', backgroundColor: '#d4edda', color: '#155724', fontSize: '0.85rem', fontWeight: 'bold' }}>
                                                Проверено
                                            </span>
                                        ) : (
                                            <span style={{ padding: '4px 10px', borderRadius: '20px', backgroundColor: '#fff3cd', color: '#856404', fontSize: '0.85rem', fontWeight: 'bold' }}>
                                                Ожидает проверки
                                            </span>
                                        )}
                                    </td>
